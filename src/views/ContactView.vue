<template>
  <div class="contact">
    ...
    <p>Hi! I'm Jaimie Black (they/them please!) and I'd love to hear about your projects.
      I'm especially interested in projects that serve to better society. If you or your project are:
    </p>
    <ul>
      <li>not-for-profit</li>
      <li>socially minded (like a community interest corporation)</li>
      <li>environmentally conscious or solarpunk-based</li>
    </ul>
